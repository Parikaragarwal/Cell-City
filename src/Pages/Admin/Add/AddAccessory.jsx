...
const AddAccessory = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await appwriteService.createDocument(config.accessoriesCollectionId, parsedData);
            reset();
        } catch (error) {
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6 min-h-screen">
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-white mb-3">Add New Accessory</h1>
                    <p className="text-slate-300">Fill in the details to create a new accessory listing.</p>
                </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input {...register("brand", { required: true })} className="w-full input-style" placeholder="e.g. Samsung" />
                                    ...
                                    <div>
                                        ...
                                        <input {...register("name", { required: true })} className="w-full input-style" placeholder="e.g. Galaxy Buds Pro" />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input {...register("image", { required: true })} className="w-full input-style" placeholder="https://..." />
                                    ...
                                    <div>
                                        ...
                                        <input type="number" {...register("price", { required: true })} className="w-full input-style" placeholder="e.g. 4999" />
                            ...
                            <div className="pt-6">
                                <button type="submit" disabled={loading} className="w-full btn-submit">
                                    {loading ? <Loader text="Creating..." /> : '🚀 Add Accessory'}
                                </button>
                            </div>
                        </form>
                    </div>
