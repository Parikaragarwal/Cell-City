  ...
  const services = [
    {
      ...
      label: "Mobiles",
      path: "/mobiles",
      description: "Latest smartphones & repairs",
    },
    {
      icon: FaHeadphones,
      label: "Accessories",
          ...
          <div className="flex items-center justify-between h-20 relative">
            ...
            <div className="flex items-center space-x-4 group">
              ...
              <div className="transition-all duration-300 group-hover:transform group-hover:translate-x-1">
                <Link
                  to="/"
                  className="text-2xl font-bold tracking-wide bg-gradient-to-r from-white via-emerald-100 to-white bg-clip-text text-transparent group-hover:from-emerald-400 group-hover:via-white group-hover:to-emerald-400 transition-all duration-300"
                >
                  Cell City
                </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                <a
                  href="https://www.google.com/maps/place/Cell+City+Communications"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-gradient-to-br hover:from-emerald-500 hover:to-emerald-600 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/25 hover:transform hover:scale-110 group"
                >
                  <FaMapMarkerAlt
                    size={16}
                ...
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-gradient-to-br hover:from-blue-500 hover:to-blue-600 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:transform hover:scale-110 group"
                >
                  <FaPhone
                    size={16}
                    className="group-hover:text-white transition-colors"
                ...
                <Link
                  to="/contact"
                  className="hidden sm:flex w-10 h-10 items-center justify-center rounded-lg bg-gray-800 hover:bg-gradient-to-br hover:from-purple-500 hover:to-purple-600 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 hover:transform hover:scale-110 group"
                >
                  <FaEnvelope
                    size={16}
                    className="group-hover:text-white transition-colors"
          ...
          <div className="fixed top-20 left-0 right-0 bg-black border-t border-gray-800 shadow-2xl">
            <div className="max-w-7xl mx-auto px-4 py-6">
              <div className="grid grid-cols-2 gap-4 mb-6">
                {services.map((service, index) => (
                  <Link
                    key={index}
                    to={service.path}
                    className="flex items-center gap-3 p-4 rounded-xl bg-gray-900 hover:bg-gray-800 transition-all duration-300 group"
                  >
                    ...
                    <div>
                      <h3 className="text-sm font-medium group-hover:text-emerald-400 transition-colors">
                        {service.label}
                      </h3>
              ...
              <div className="space-y-3">
                <Link
                  to="/about"
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-emerald-400 border border-emerald-400/30 rounded-lg hover:bg-emerald-400 hover:text-black transition-all duration-300 hover:shadow-lg hover:shadow-emerald-400/25 hover:transform hover:scale-105"
                >
                  <FaUsers size={14} />
                  About Us
                </Link>
                <div className="grid grid-cols-2 gap-3">
                  <a
                    href="tel:+917895431497"
                    className="flex items-center justify-center gap-2 p-3 rounded-xl bg-blue-600 text-white font-medium transition-all duration-300 hover:bg-blue-500"
                  >
                    <FaPhone size={14} />
                    Call Now
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 p-3 rounded-xl bg-purple-600 text-white font-medium transition-all duration-300 hover:bg-purple-500"
                  >
