...
import { Zap, Headphones, Shield, Package } from "lucide-react";

const ELECTRONIC_TYPES = [
  { label: "Smart TV", icon: Zap },
  { label: "AC", icon: Shield },
  { label: "Speaker", icon: Headphones },
  { label: "Extras", icon: Package },
];

const ElectronicsFilterContent = ({
  priceRange,
  setPriceRange,
  selectedTypes,
  setSelectedTypes,
...
export default ElectronicsFilterContent;
